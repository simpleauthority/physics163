...
scene.width = 800
scene.height = 600
scene.title = "<h2>Problem 22.23</h2><p>Simulates the electric field at a particular point of interest located at the origin due to uniformly charged arc of radius R.</p><br />"
